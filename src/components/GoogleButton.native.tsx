...
// Configuración única del SDK nativo. webClientId se usa como "serverClientId":
// hace que el idToken devuelto tenga como audience el Web Client ID, que es
// justo el que valida nuestro backend.
